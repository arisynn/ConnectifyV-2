...
export type CDEOperationType = 'MUTATE_PERMEN' | 'UPDATE_PROFILE' | 'UPDATE_GAME_STATE' | 'PURCHASE_ITEM' | 'EQUIP_COSMETIC' | 'USE_ITEM' | 'PROCESS_WIN' | 'RECORD_ATTEMPT' | 'CLAIM_MISSION_REWARD' | 'OPEN_CHEST' | 'SPEED_UP_CHEST' | 'CLAIM_ACHIEVEMENT_REWARD';
